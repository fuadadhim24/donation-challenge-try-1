...
<template>
    <Head>
        ...
        <!-- Title -->
        <title>
            Coffee Shop Tailwind CSS Template | Preline UI, crafted with
            Tailwind CSS
        </title>
    ...
    <main id="content">
        ...
        <div class="px-4 sm:px-6 lg:px-8">
            ...
            >
                <div
                    class="mt-auto w-2/3 md:max-w-lg ps-5 pb-5 md:ps-10 md:pb-10"
                >
                ...
                <div class="group flex flex-col">
                    <div class="relative">
                        <div class="aspect-4/4 overflow-hidden rounded-2xl">
                            <img
                                ...
                                src="https://preline.co/assets/img/pro/coffee-shop/img1.png"
                                alt="Product Image"
                            />
                        </div>
                        ...
                        <div class="pt-4">
                            <h3
                                class="font-medium md:text-lg text-black dark:text-white"
                            >
                                Beija Flor
                            </h3>

                            <p
                                class="mt-2 font-semibold text-black dark:text-white"
                            >
                                $5.50
                            </p>
                        </div>
                    ...
                    <div class="mb-2 mt-4 text-sm">
                        ...
                        <div class="flex flex-col">
                            <!-- Item -->
                            <div
                                class="py-3 border-t border-gray-200 dark:border-neutral-700"
                            >
                    ...
                    <div class="mt-auto">
                        <a
                            class="py-2 px-3 w-full inline-flex justify-center items-center gap-x-2 text-sm font-medium text-nowrap rounded-xl border border-transparent bg-blue-400 text-black hover:bg-blue-600 focus:outline-hidden focus:bg-blue-600 transition disabled:opacity-50 disabled:pointer-events-none"
                            href="bag.html"
                        >
                            Buy now
                        </a>
                ...
                <div class="group flex flex-col">
                    <div class="relative">
                        <div class="aspect-4/4 overflow-hidden rounded-2xl">
                            <img
                                class="size-full object-cover rounded-2xl"
                                src="https://preline.co/assets/img/pro/coffee-shop/img2.png"
                                alt="Product Image"
                            />
                        </div>
                ...
                <div class="group flex flex-col">
                    <div class="relative">
                        <div class="aspect-4/4 overflow-hidden rounded-2xl">
                            <img
                                class="size-full object-cover rounded-2xl"
                                src="https://preline.co/assets/img/pro/coffee-shop/img5.png"
                                alt="Product Image"
                            />
                        </div>
                ...
                <div class="group flex flex-col">
                    <div class="relative">
                        <div class="aspect-4/4 overflow-hidden rounded-2xl">
                            <img
                                class="size-full object-cover rounded-2xl"
                                src="https://preline.co/assets/img/pro/coffee-shop/img7.png"
                                alt="Product Image"
                            />
                        </div>
                ...
                <div class="group flex flex-col">
                    <div class="relative">
                        <div class="aspect-4/4 overflow-hidden rounded-2xl">
                            <img
                                class="size-full object-cover rounded-2xl"
                                src="https://preline.co/assets/img/pro/coffee-shop/img3.png"
                                alt="Product Image"
                            />
                        </div>
        ...
        <div class="px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 md:items-center">
                <div
                    class="relative h-80 md:h-150 bg-gray-100 rounded-2xl dark:bg-neutral-800"
                >
                    <img
                ...
                <div class="pt-10 md:p-10">
                    <blockquote class="max-w-4xl mx-auto">
                        ...
                        >
                            Coffee has the power to connect generations –
                            whether it's learning grandma's brewing techniques
                            and trying to perfect them just like her or the
                            intense memories triggered by the rich flavors and
                            aromas of our favorite coffee blends.
                        </p>
                    ...
                    <div>
                        ...
                        >
                            <div class="flex gap-4">
                                <svg
                                    class="shrink-0 size-5 text-gray-500 dark:text-neutral-500"
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                                ...
                                <div class="grow">
                                    ...
                                    <address
                                        class="mt-1 text-black not-italic dark:text-white"
                                    >
...
<!-- <template>
    <div class="max-w-2xl mx-auto py-16 text-center">
        <h1 class="text-4xl font-bold mb-6">Welcome to Donation Hub!</h1>
