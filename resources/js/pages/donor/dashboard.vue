...
const title = "Dashboard Donor | Donation Hub";
onMounted(() => {
                    ...
                    <div class="p-4 md:p-5">
                        ...
                        <div class="flex items-center mt-1 gap-x-2">
                            <h3
                                class="text-xl font-medium text-gray-800 sm:text-2xl dark:text-neutral-200"
                            >
                                {{ props.summary.total_projects }} Proyek
                            </h3>
                        </div>
                    </div>
                </div>
                        ...
                        >
                            ...
                            >
                                <div>
                                    ...
                                    >
                                        Kebaikan anda berarti penting bagi
                                        mereka
                                    </p>
                                </div>
                            ...
                            >
                                ...
                                >
                                    <tr
                                        v-for="donation in props.donations"
                                        :key="donation.id"
                                    >
                                        <!-- Nama Project -->
                                        <td class="px-6 py-3">
